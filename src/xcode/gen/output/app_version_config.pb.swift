...
// Source: app_version_config.proto
//
...
struct SAP_ApplicationVersionConfiguration {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var ios: SAP_ApplicationVersionInfo {
    get {return _ios ?? SAP_ApplicationVersionInfo()}
    set {_ios = newValue}
  }
  ...
  var android: SAP_ApplicationVersionInfo {
    get {return _android ?? SAP_ApplicationVersionInfo()}
  ...
  fileprivate var _ios: SAP_ApplicationVersionInfo? = nil
  fileprivate var _android: SAP_ApplicationVersionInfo? = nil
}

struct SAP_ApplicationVersionInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var latest: SAP_SemanticVersion {
    get {return _latest ?? SAP_SemanticVersion()}
  ...
  var min: SAP_SemanticVersion {
    get {return _min ?? SAP_SemanticVersion()}
    set {_min = newValue}
  }
  ...
  fileprivate var _latest: SAP_SemanticVersion? = nil
  fileprivate var _min: SAP_SemanticVersion? = nil
}

struct SAP_SemanticVersion {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension SAP_ApplicationVersionConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_ApplicationVersionConfiguration, rhs: SAP_ApplicationVersionConfiguration) -> Bool {
...
extension SAP_ApplicationVersionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SAP_ApplicationVersionInfo, rhs: SAP_ApplicationVersionInfo) -> Bool {
...
extension SAP_SemanticVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
